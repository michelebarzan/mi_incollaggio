<?php
	...
	else
	{
		while($row=sqlsrv_fetch_array($result))
		{
			...
			/*if($row['ruotato']=='true')
			{
				echo "<div style='height:110px;margin-top:345px;width:100%;overflow:hidden;border:3px solid red;color:red;background:yellow;font-family:Exo,Arial;font-size:120%;font-weight:bold;' ><input type='button' id='alert' value='' /><br>Attenzione !<br>Pannello ruotato</div>";
			}*/
		}
	}
	//echo $codPan;
