...
<html>
	...
	<body onload="fullscreen();javascript:document.getElementById('pdf').focus();" style="height:1080px;width:1920px;display: inline-block;margin:0px auto;">
