<?php
	...
	else
	{
		while($row=sqlsrv_fetch_array($result))
		{
			if($row['ruotato']=='true')
			{
				echo "<div style='border:3px solid red;box-sizing: border-box;height:60px;line-height:60px;width:400px;overflow:hidden;margin-top:2px;display:inline-block;color:red;background:yellow;font-family:Exo,Arial;font-size:120%;font-weight:bold;'><input type='button' id='alert' value='' style='float:left;margin-left:20px;' />Attenzione ! Pannello ruotato</div>";
			}
		}
	}
	//echo $codPan;
