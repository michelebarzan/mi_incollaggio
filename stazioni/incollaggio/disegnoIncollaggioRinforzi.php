<?php
	...
	$queryRinforzi="SELECT * FROM rinforzi_nofiltro WHERE CODPAS='".$codPan."'";
	...
	if($LUNG1=='' || $LUNG1==NULL)
	{
		echo "<br><br><b style='font-size:300%;color:red;font-family:Monospace'>NESSUN PANNELLO IN CODA</b>";
		die();
	}
	
	$queryRinforzi_T="SELECT * FROM rinforzi_T_nofiltro WHERE CODPAS='".$codPan."'";
	...
	$queryRinforzi_P="SELECT * FROM rinforzi_P_nofiltro WHERE CODPAS='".$codPan."'";
