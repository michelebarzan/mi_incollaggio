<?php
	...
	$query="SELECT TOP (1) codPan, lotto,id_produzione,finitura,eliminato,posizione FROM produzione WHERE mRinforzi='true' AND mIncollaggio='false' ORDER BY posizione ASC";
	...
	else
	{
		...
		$query2="UPDATE produzione SET vIncollaggio='true' WHERE id_produzione=$id_produzione";
