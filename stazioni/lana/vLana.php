<?php
	...
	$query="SELECT mLana FROM produzione WHERE codPan='$codPan' AND vLana='true' AND id_produzione=$id_produzione";
	...
	if($mLana=="true")
	{
		$query2="UPDATE produzione SET vLana='false',utenteLana=".getUtente($conn,$_SESSION['Username'])." WHERE codPan='$codPan' AND vLana='true' AND id_produzione=$id_produzione";
