<?php
	...
	$query="SELECT TOP (1) codPan, lotto,id_produzione,eliminato,finitura,posizione FROM produzione WHERE mRinforzi='false' AND mAcqua='true' ORDER BY posizione ASC";
	//$query="SELECT TOP (1) codPan, lotto,id_produzione FROM produzione WHERE mCaricamento='true' AND mRinforzi='false' ORDER BY posizione DESC";
	...
	else
	{
		...
		$query2="UPDATE produzione SET vRinforzi='true' WHERE id_produzione=$id_produzione";
