<?php
	...
	$query="SELECT TOP (1) codPan, lotto,id_produzione,finitura,eliminato,posizione FROM produzione WHERE mRinforzi1='false' AND mCaricamento='true' ORDER BY posizione ASC";
	//$query="SELECT TOP (1) codPan, lotto,id_produzione FROM produzione WHERE mCaricamento='true' AND mRinforzi1='false' ORDER BY posizione DESC";
	...
	else
	{
		...
		$query2="UPDATE produzione SET vRinforzi1='true' WHERE id_produzione=$id_produzione";
