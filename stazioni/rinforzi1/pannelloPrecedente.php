...
<html>
		...
		<script>
			function getPannelloPrecedente()
			{
				...
				xmlhttp2.onreadystatechange = function() 
				{
					...
					{
						document.getElementById('disegnoRinforziPrecedente').innerHTML=this.responseText;
					}
				};
				xmlhttp2.open("POST", "disegnoRinforziPrecedente.php?codPan="+codPan, true);
				xmlhttp2.send();
			}
	...
	<div id="disegnoRinforziPrecedente"></div>
	<hr size='1' color="gray" />
	</body>
</html>